                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h2 className="text-3xl font-black text-slate-900 tracking-tighter text-center leading-tight">
                            Admin <span className="text-purple-600">Core</span>
                        </h2>
                        <p className="text-slate-500 font-bold mt-2 text-sm uppercase tracking-widest">Authorized Personnel Only</p>
                    </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2 flex items-center gap-2">
                                    <User className="h-3 w-3 text-purple-500" /> Username
                                </label>
