                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h2 className="text-3xl font-black text-slate-900 tracking-tighter text-center leading-tight">
                            Staff <span className="text-cyan-600">Portal</span>
                        </h2>
                        <p className="text-slate-500 font-bold mt-2 text-sm uppercase tracking-widest">Ground Operations</p>
                    </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2 flex items-center gap-2">
                                    <User className="h-3 w-3 text-cyan-500" /> Username
                                </label>
                                <div className="relative group">
                                    <Input
                                        ...
                                        required
                                        className="h-14 bg-white/50 border-2 border-white/20 focus:border-cyan-500 rounded-2xl px-6 transition-all font-medium text-slate-900 placeholder:text-slate-400"
                                        disabled={loading}
                                    />
                                    <div className="absolute inset-0 rounded-2xl ring-2 ring-cyan-500/20 opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none" />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2 flex items-center gap-2">
                                    <Key className="h-3 w-3 text-blue-500" /> Password
                                </label>
                                <div className="relative group">
                                    <Input
                                        type="password"
                            ...
                            >
                                ...
                                {loading ? (
                                    ...
                                    <div className="flex items-center justify-center gap-2">
                                        Access Portal <LogIn className="h-5 w-5" />
                                    </div>
                                )}
                            </Button>
